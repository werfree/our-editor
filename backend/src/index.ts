...
app.post("/api/editor/join", (req: express.Request, res: express.Response, next: express.NextFunction) => {
    const { editorId, clientId, clientName }: { editorId: string, clientId: string, clientName: string } = req.body
